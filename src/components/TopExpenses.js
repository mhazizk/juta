import {
    ScrollView, StyleSheet, Text, TouchableNativeFeedback, View
} from "react-native";
        ...
        <TouchableNativeFeedback onPress={() => {}}>
          <View style={styles.flatListView}>
            ...
            <View style={styles.flatListViewUnderscore}>
              ...
              <View
                style={{ ...styles.flatListViewText, flexDirection: "row" }}
              >
                <Text
                  style={{
                    ...styles.flatListViewText,
                    fontSize: 14,
                    color: "#bbbbbb",
                    marginRight: 4,
                  }}
                ...
                <Text style={{ ...styles.flatListViewText, fontSize: 18 }}>
                  100.000.000
                </Text>
              </View>
            </View>
