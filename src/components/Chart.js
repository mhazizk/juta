// TODO : Remove this file as it is not used anymore
...
//           <Text
//             style={{
//               ...globalStyles.lightTheme.textSecondary,
//               fontSize: 16,
//               paddingRight: 4,
//             }}
//           >
...
//           }}
//         >
//           Total expenses this {chartFilter.expenseFilter}
//         </Text>
...
//           <TouchableOpacity
//             onPress={() => {
//               setChartFilter({ ...chartFilter, expenseFilter: "week" });
//               setChartData({ data1: dataA, data2: dataB });
//             }}
//           >
//             <View
//               style={{
...
//                 flex: 0,
//                 backgroundColor: `${
//                   chartFilter.expenseFilter === "week" ? "#000" : "#fff"
//                 }`,
//                 height: 48,
//                 width: 100,
...
//                   fontSize: 16,
//                   color: `${
//                     chartFilter.expenseFilter === "week" ? "#fff" : "#000"
//                   }`,
//                 }}
//               >
//                 Week
...
//           <TouchableOpacity
//             onPress={() => {
//               setChartFilter({ ...chartFilter, expenseFilter: "month" });
//               setChartData({ data1: dataC, data2: dataD });
//             }}
//           >
//             <View
//               style={{
...
//                 flex: 0,
//                 backgroundColor: `${
//                   chartFilter.expenseFilter === "month" ? "#000" : "#fff"
//                 }`,
//                 height: 48,
//                 width: 100,
//                 justifyContent: "center",
...
//                   fontSize: 16,
//                   color: `${
//                     chartFilter.expenseFilter === "month" ? "#fff" : "#000"
//                   }`,
//                 }}
//               >
//                 Month
...
//           <TouchableOpacity
//             onPress={() => {
//               setChartFilter({ ...chartFilter, expenseFilter: "year" });
//               setChartData({ data1: dataE, data2: dataF });
//             }}
//           >
//             <View
//               style={{
...
//                 flex: 0,
//                 backgroundColor: `${
//                   chartFilter.expenseFilter === "year" ? "#000" : "#fff"
//                 }`,
//                 height: 48,
//                 width: 100,
//                 justifyContent: "center",
...
//                   fontSize: 16,
//                   color: `${
//                     chartFilter.expenseFilter === "year" ? "#fff" : "#000"
//                   }`,
//                 }}
//               >
//                 Year
