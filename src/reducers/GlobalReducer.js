...
//     // TAG : Patch many transactions method
...
//       // use sample transaction in newPatchedTransactions to find the logbook from state.groupSorted

//       // find the previous logbook id
//       let prevLogbookId = null;
//       state.groupSorted.forEach((logbook) => {
//         logbook.transactions.forEach((section) => {
//           section.data.forEach((transaction) => {
//             if (
...
//             ) {
//               prevLogbookId = logbook.logbook_id;
//             }
//           });
//         });
//       });
...
//       if (prevLogbookId) {
//         isLogbookIdSame =
//           prevLogbookId === newPatchedTransactions[0].logbook_id;
//       }
...
//         // 3. create new custom date for previous transaction
...
//         // if the logbook id is the same, then just patch the transaction
//         if (isLogbookIdSame) {
//           // if the date is the same, then just patch the transaction
//           if (customPatchDate === customPrevDate) {
//             // 4. find the section
//             const foundSection = state.groupSorted
//               .find((logbook) => {
//                 return logbook.logbook_id === newPatchedTransaction.logbook_id;
//               })
...
//             // 4. find the previous section
//             const foundPreviousSection = state.groupSorted
//               .find((logbook) => {
//                 return logbook.logbook_id === prevTransaction.logbook_id;
//               })
//               .transactions.find((section) => {
...
//             // 5. remove the transaction from section
...
//                   return (
//                     transaction.transaction_id !==
//                     prevTransaction.transaction_id
//                   );
//                 }),
//               ].sort(sortTransactionsDate),
//             };

//             // 6. put the new previous section back to the logbook
...
//   }
// };
// TODO : Delete All Counter in this reducer
