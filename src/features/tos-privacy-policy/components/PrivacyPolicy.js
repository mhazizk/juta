    ...
    <>
      ...
      >
        **Privacy Policy**
        {"\n"}
        {"\n"}
        mhazizk built the Juta app as a Freemium app. This SERVICE is provided
        by mhazizk at no cost and is intended for use as is. This page is used
        ...
        meanings as in our Terms and Conditions, which are accessible at Juta
        ...
        including but not limited to name, email, device id, payment. The
        ...
        **Service Providers**
        ...
        their Personal Information. The reason is to perform the tasks assigned
        ...
        **Children’s Privacy**
        ...
        policy is effective as of 2023-02-01
        {"\n"}
        {"\n"}
        **Contact Us**
        {"\n"}
        ...
        hesitate to contact me at mhazizk@gmail.com.
      </MarkdownView>
    </>
  );
};
