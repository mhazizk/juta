  ...
  return (
    <>
      ...
      >
        ...
        {"\n"}
        {"\n"}
        mhazizk is committed to ensuring that the app is as useful and efficient
        ...
        {"\n"}
        {"\n"}
        The Juta app stores and processes personal data that you have provided
        ...
        features and it could mean that the Juta app won’t work properly or at
        all.
        {"\n"}
        {"\n"}
        ...
        {"\n"}
        {"\n"}
        You should be aware that there are certain things that mhazizk will not
        ...
        or provided by your mobile network provider, but mhazizk cannot take
        ...
        {"\n"}
        {"\n"}
        Along the same lines, mhazizk cannot always take responsibility for the
        ...
        the Service, mhazizk cannot accept responsibility.
        {"\n"}
        {"\n"}
        With respect to mhazizk’s responsibility for your use of the app, when
        ...
        it available to you. mhazizk accepts no liability for any loss, direct
        ...
        to keep using the app. mhazizk does not promise that it will always
        ...
        **Contact Us**
        ...
        do not hesitate to contact me at mhazizk@gmail.com.
      </MarkdownView>
    </>
  );
};
