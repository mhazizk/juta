...
const EditInitialBalanceScreen = ({ route, navigation }) => {
  ...
  useEffect(() => {
    ...
    setTransaction(route.params?.initialTransaction || newTransaction);
    setPrevTransaction(route.params?.initialTransaction);
  ...
  const handleDeleteTransaction = () => {
    Alert.alert(
      ...
      "Are you sure you want to delete this initial balance?",
      [
        {
          text: "Cancel",
          style: "cancel",
        },
        {
          ...
          onPress: () => {
            ...
            //   isPaid: false,
            //   label: "Deleting Initial Balance...",
  ...
  const checkFinalTransaction = () => {
    ...
    return navigation.navigate(screenList.loadingScreen, {
      label: "Saving Initial Balance...",
      loadingType: LOADING_TYPES.TRANSACTIONS.PATCH_ONE,
      logbookToOpen: selectedLogbook,
      isPaid: false,
      willPrevLoanContactBePaid: false,
      willTargetLoanContactBePaid: false,
