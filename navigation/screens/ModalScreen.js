...
const ModalScreen = ({ route, navigation }) => {
    ...
    return (
        <>
            {/* // ! Transparent Overlay */}
            <TouchableOpacity onPress={() => navigation.navigate('Bottom Tab')} style={{ flex: 1, backgroundColor: 'transparent' }}>
            ...
            <View
                ...
                <FlatList
                    style={{ ...globalStyles.lightTheme.view, paddingVertical: 16 }}
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
                    ...
                    <View style={{
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('Bottom Tab')}>
