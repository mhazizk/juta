                ...
                <View style={{ height: '100%', backgroundColor: '#fff' }}>
                    ...
                    <TouchableNativeFeedback
                        onPress={() => navigation.navigate(
                            ...
                            title: 'Language',
                            modalType: 'list',
                            props: APP_SETTINGS.LANGUAGE.OPTIONS.map((option) => { return { name: option } }),
                            selected: (item) => dispatchAppSettings({ type: ACTIONS.APP_SETTINGS.LANGUAGE.SET, payload: item.name }),
