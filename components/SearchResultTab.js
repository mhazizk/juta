...
const SearchResultTab = () => {
    ...
    return (
        <Tab.Navigator
            screenOptions={({ route }) => ({
                tabBarIndicatorStyle: { backgroundColor: appSettings.theme.style.colors.textHeader, borderRadius: 16, height: 3, marginBottom: 0 },
                tabBarActiveTintColor: appSettings.theme.style.colors.textHeader,
                tabBarInactiveTintColor: appSettings.theme.style.text.textSecondary.color,
                tabBarIndicatorContainerStyle: { backgroundColor: appSettings.theme.style.colors.header, justifyContent: 'center' },
                tabBarIconStyle: {},
            ...
            <Tab.Screen options={{ title: 'Log Books' }} name={search.logbookSearchScreen} component={LogBookSearchScreen} />
            <Tab.Screen options={{ title: 'Categories' }} name={search.categorySearchScreen} component={CategorySearchScreen} />
        </Tab.Navigator >
    )
}
