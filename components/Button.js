...
import { TextButtonPrimary, TextButtonSecondary, TextDanger, TextPrimary, TextSecondary } from "./Text"
...
// ! Button Primary
export const ButtonPrimary = ({ label, props, onPress, condition, theme, width, style }) => {
...
// ! Button Secondary
export const ButtonSecondary = ({ label, props, onPress, condition, theme, width, style }) => {
    const { appSettings, dispatchAppSettings } = useGlobalAppSettings();
...
// ! Button Icon Danger
export const ButtonIconDanger = ({ label, props, onPress, condition, theme, width, iconName, style }) => {
    ...
    return (
        <>
            <TouchableOpacity onPress={onPress}>
                <View style={[
                    {
                        backgroundColor: theme.button.buttonDanger.backgroundColor || 'transparent',
                    ...
                    <View style={{ height: '100%', width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        {iconName && <IonIcons name={iconName} size={16} color={theme.colors.danger || lightTheme.colors.danger} />}
...
// ! Button Icon Success
export const ButtonIconSuccess = ({ label, props, onPress, condition, theme, width, iconName, style }) => {
    ...
    return (
        <>
            <TouchableOpacity onPress={onPress}>
                <View style={[
                    {
                        ...theme.button.buttonSuccess || lightTheme.button.buttonSuccess,
                        minWidth: 80,
                        minHeight: 48,
                        width: (width || null),
                        paddingHorizontal: 16,
                    ...
                    <View style={{ height: '100%', width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        {iconName && <IonIcons name={iconName} size={16} color={theme.colors.success || lightTheme.colors.success} />}
                        <TextDanger label={label} theme={theme} />
                    </View>
                </View>
            </TouchableOpacity>
