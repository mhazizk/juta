        ...
        <>
            {userAccount &&
                <View style={{
                    ...
                    <View style={{ alignItems: 'center', justifyContent: 'center', borderColor: appSettings.theme.style.colors.primary, height: 128, width: 128, borderRadius: 128 / 2, borderWidth: 3 }}>
                        {/* <Image source={checkmark} style={{ height: 128, width: 128 }} /> */}
                        <IonIcons name='person' size={64} color={appSettings.theme.style.colors.primary} style={{ display: !userAccount.profile.avatar ? 'flex' : 'none' }} />
                    </View>
